...
#ifndef XLA_BACKENDS_GPU_TRANSFORMS_SOFTMAX_REWRITER_TRITON_H_
#define XLA_BACKENDS_GPU_TRANSFORMS_SOFTMAX_REWRITER_TRITON_H_
...
#endif  // XLA_BACKENDS_GPU_TRANSFORMS_SOFTMAX_REWRITER_TRITON_H_
