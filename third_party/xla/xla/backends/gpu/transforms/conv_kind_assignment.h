...
#ifndef XLA_BACKENDS_GPU_TRANSFORMS_CONV_KIND_ASSIGNMENT_H_
#define XLA_BACKENDS_GPU_TRANSFORMS_CONV_KIND_ASSIGNMENT_H_
...
#endif  // XLA_BACKENDS_GPU_TRANSFORMS_CONV_KIND_ASSIGNMENT_H_
