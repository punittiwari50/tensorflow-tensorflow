...
#ifndef XLA_BACKENDS_GPU_TRANSFORMS_COLLECTIVES_REDUCE_SCATTER_COMBINER_H_
#define XLA_BACKENDS_GPU_TRANSFORMS_COLLECTIVES_REDUCE_SCATTER_COMBINER_H_
...
#endif  // XLA_BACKENDS_GPU_TRANSFORMS_COLLECTIVES_REDUCE_SCATTER_COMBINER_H_
