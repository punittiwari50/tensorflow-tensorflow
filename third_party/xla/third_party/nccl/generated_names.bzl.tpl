...
GENERATED_SOURCES = [
    ...
    "src/device/generated_symmetric/all_gather.cu.cc",
    "src/device/generated_symmetric/all_reduce.cu.cc",
    "src/device/generated_symmetric/all_reduce_sum_bf16.cu.cc",
    "src/device/generated_symmetric/all_reduce_sum_f16.cu.cc",
    "src/device/generated_symmetric/all_reduce_sum_f32.cu.cc",
    "src/device/generated_symmetric/all_reduce_sum_f8e4m3.cu.cc",
    "src/device/generated_symmetric/all_reduce_sum_f8e4m3_RSxLDMC_AGxSTMC.cu.cc",
    "src/device/generated_symmetric/all_reduce_sum_f8e5m2.cu.cc",
    "src/device/generated_symmetric/all_reduce_sum_f8e5m2_RSxLDMC_AGxSTMC.cu.cc",
    "src/device/generated_symmetric/reduce_scatter.cu.cc",
    "src/device/generated_symmetric/reduce_scatter_sum_bf16.cu.cc",
    "src/device/generated_symmetric/reduce_scatter_sum_f16.cu.cc",
    "src/device/generated_symmetric/reduce_scatter_sum_f32.cu.cc",
    "src/device/generated_symmetric/reduce_scatter_sum_f8e4m3.cu.cc",
    "src/device/generated_symmetric/reduce_scatter_sum_f8e4m3_LDMC.cu.cc",
    "src/device/generated_symmetric/reduce_scatter_sum_f8e5m2.cu.cc",
    "src/device/generated_symmetric/reduce_scatter_sum_f8e5m2_LDMC.cu.cc",
    "src/device/generated_symmetric/symmetric_kernels.cc",
]
